...
const GlobalHeaderStory = withInfo(
  `
    ...
    - add, search, notifications (icons) are visible only when correspdoning callback properties (*addIconCallback*, *searchIconCallback*, *notificationIconCallback*). If *profileId* property is provided, it will be passed to each of these callbacks.
    - GlobalHeader component depends on GlobalHeaderIcon component to render add, search, notificaitons functionality.
